...
public class TeakForest extends Biome 
{
	protected static final WorldGenAbstractTree teak_tree = new TeakTree(true, true);
	
	public TeakForest() 
	{
		super(new BiomeProperties("Teak Forest").setBaseHeight(0.1F).setHeightVariation(0.2F).setTemperature(0.5F).setRainfall(0.5F).setWaterColor(16777215));
