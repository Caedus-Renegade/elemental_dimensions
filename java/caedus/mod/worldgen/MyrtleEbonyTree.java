...
public class MyrtleEbonyTree extends WorldGenAbstractTree 
{
	public static final IBlockState LOG = BlockInit.EBONY_LOG.getDefaultState().withProperty(EbonyLog.VARIANT, EbonyTreeEnumHandler.EnumType.EBONY);
	public static final IBlockState LEAF = BlockInit.EBONY_LEAVES.getDefaultState().withProperty(EbonyLeaves.VARIANT, EbonyTreeEnumHandler.EnumType.EBONY);
	
	private final int minHeight;
	
	public MyrtleEbonyTree() 
	{
		super(false);
		this.minHeight = 12;
	}
