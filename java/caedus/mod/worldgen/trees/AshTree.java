package caedus.mod.worldgen.trees;
...
{
	public static final IBlockState LOG = BlockInit.ash_log.getDefaultState().withProperty(AshLog.VARIANT, AshTreeEnumHandler.EnumType.ASH);
	public static final IBlockState LEAF = BlockInit.ash_leaves.getDefaultState().withProperty(AshLeaves.VARIANT, AshTreeEnumHandler.EnumType.ASH);
	...
	public boolean generate(World world, Random rand, BlockPos pos) 
	{
		...
		else
		{
			...
			boolean isSoil = state.getBlock().canSustainPlant(state, world, down, EnumFacing.UP, (AshSapling)BlockInit.ash_sapling);
