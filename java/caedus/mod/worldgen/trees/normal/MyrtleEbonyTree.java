package caedus.mod.worldgen.trees.normal;
...
{
//	public static final IBlockState LOG = BlockInit.myrtle_ebony_log.getDefaultState().withProperty(MyrtleEbonyLog.VARIANT, TreeEnumHandler.EnumType.BASE);
//	public static final IBlockState LEAF = BlockInit.myrtle_ebony_leaves.getDefaultState().withProperty(MyrtleEbonyLeaves.VARIANT, TreeEnumHandler.EnumType.BASE);
	
    private final boolean useExtraRandomHeight;

    public MyrtleEbonyTree(boolean notify, boolean useExtraRandomHeightIn)
    {
        super(notify);
