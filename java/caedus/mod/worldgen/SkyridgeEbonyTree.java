...
public class SkyridgeEbonyTree extends WorldGenAbstractTree 
{
	public static final IBlockState LOG = BlockInit.EBONY_LOG.getDefaultState().withProperty(EbonyLog.VARIANT, EbonyTreeEnumHandler.EnumType.SKYRIDGE);
	public static final IBlockState LEAF = BlockInit.EBONY_LEAVES.getDefaultState().withProperty(EbonyLeaves.VARIANT, EbonyTreeEnumHandler.EnumType.SKYRIDGE);
	
	private final int minHeight;
	
	public SkyridgeEbonyTree() 
	{
		super(false);
		this.minHeight = 16;
	}
	...
	public boolean generate(World world, Random rand, BlockPos pos) 
	{
		...
		else
		{
			...
			boolean isSoil = state.getBlock().canSustainPlant(state, world, down, EnumFacing.UP, (EbonySapling)BlockInit.EBONY_SAPLINGS);
	...
	protected boolean canGrowInto(Block blockType)
	{
        ...
        return material == Material.AIR || material == Material.LEAVES || material == Material.GROUND || blockType == Blocks.GRASS || blockType == Blocks.DIRT || blockType == BlockInit.ZEPHYRSTONE || blockType == Blocks.LOG || blockType == Blocks.LOG2 || blockType == Blocks.SAPLING || blockType == Blocks.VINE;
