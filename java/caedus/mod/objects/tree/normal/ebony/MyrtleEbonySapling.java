...
public class MyrtleEbonySapling extends BlockBush implements IGrowable, IMetaName, IHasModel
{	
    ...
    public MyrtleEbonySapling(String name) 
    {
	...
	public void registerModels() 
	{
		...
		{
			Main.proxy.registerVariantRenderer(Item.getItemFromBlock(this), i, "ebony_sapling" + "_" + TreeEnumHandler.EnumType.values()[i].getName(), "inventory");
		}
	}
	...
	public void generateTree(World world, Random rand, BlockPos pos, IBlockState state)
	{
		...
		{
		case BASE:
			gen = new MyrtleEbonyTree(false, false);
			break;
		}
