...
public class MyrtleEbonyLeaves extends BlockLeaves implements IMetaName, IHasModel
{
	...
	public MyrtleEbonyLeaves(String name) 
	{
...
//	{
//		return Item.getItemFromBlock(BlockInit.myrtle_ebony_sapling);
//	}
	...
	public void registerModels() 
	{
		...
		{
			Main.proxy.registerVariantRenderer(Item.getItemFromBlock(this), i, "ebony_leaves" +"_" + TreeEnumHandler.EnumType.values()[i].getName(), "inventory");
		}
	}
}