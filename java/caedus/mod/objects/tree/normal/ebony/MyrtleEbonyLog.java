...
public class MyrtleEbonyLog extends BlockLog implements IMetaName, IHasModel
{
	...
	public MyrtleEbonyLog(String name) 
	{
	...
	public void registerModels() 
	{
		...
		{
			Main.proxy.registerVariantRenderer(Item.getItemFromBlock(this), i, "ebony_log_" + TreeEnumHandler.EnumType.values()[i].getName(), "inventory");
		}
	}	
}