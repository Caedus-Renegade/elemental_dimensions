package caedus.mod.objects.tree.normal.teak;
...
public class TeakLeaves extends BlockLeaves implements IMetaName, IHasModel
{
...
//	{
//		return Item.getItemFromBlock(BlockInit.teak_sapling);
//	}
	...
	public void registerModels() 
	{
		...
		{
			Main.proxy.registerVariantRenderer(Item.getItemFromBlock(this), i, "teak_leaves" +"_" + TreeEnumHandler.EnumType.values()[i].getName(), "inventory");
		}
	}
}