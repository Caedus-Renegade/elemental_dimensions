...
public class TeakLog extends BlockLog implements IMetaName, IHasModel
{
	...
	public void registerModels() 
	{
		...
		{
			Main.proxy.registerVariantRenderer(Item.getItemFromBlock(this), i, "teak_log_" + TreeEnumHandler.EnumType.values()[i].getName(), "inventory");
		}
	}	
}