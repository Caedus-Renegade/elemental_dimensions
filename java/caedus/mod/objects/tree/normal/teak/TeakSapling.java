...
public class TeakSapling extends BlockBush implements IGrowable, IMetaName, IHasModel
{	
    ...
    public TeakSapling(String name) 
    {
	...
	public void registerModels() 
	{
		...
		{
			Main.proxy.registerVariantRenderer(Item.getItemFromBlock(this), i, "teak_sapling" + "_" + TreeEnumHandler.EnumType.values()[i].getName(), "inventory");
		}
	}
