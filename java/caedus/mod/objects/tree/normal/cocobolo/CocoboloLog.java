...
public class CocoboloLog extends BlockLog implements IMetaName, IHasModel
{
	...
	public CocoboloLog(String name) 
	{
	...
	public void registerModels() 
	{
		...
		{
			Main.proxy.registerVariantRenderer(Item.getItemFromBlock(this), i, "cocobolo_log_" + TreeEnumHandler.EnumType.values()[i].getName(), "inventory");
		}
	}	
}