package caedus.mod.objects.tree.normal.cocobolo;
...
public class CocoboloLeaves extends BlockLeaves implements IMetaName, IHasModel
{
	...
	public CocoboloLeaves(String name) 
	{
...
//	{
//		return Item.getItemFromBlock(BlockInit.cocobolo_sapling);
//	}
	...
	public void registerModels() 
	{
		...
		{
			Main.proxy.registerVariantRenderer(Item.getItemFromBlock(this), i, "cocobolo_leaves" +"_" + TreeEnumHandler.EnumType.values()[i].getName(), "inventory");
		}
	}
}