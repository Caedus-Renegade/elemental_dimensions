...
public class CocoboloSapling extends BlockBush implements IGrowable, IMetaName, IHasModel
{	
    ...
    public CocoboloSapling(String name) 
    {
	...
	public void registerModels() 
	{
		...
		{
			Main.proxy.registerVariantRenderer(Item.getItemFromBlock(this), i, "cocobolo_sapling" + "_" + TreeEnumHandler.EnumType.values()[i].getName(), "inventory");
		}
	}
	...
	public void generateTree(World world, Random rand, BlockPos pos, IBlockState state)
	{
		...
		{
		case BASE:
			gen = new CocoboloTree(false, false);
			break;
		}
