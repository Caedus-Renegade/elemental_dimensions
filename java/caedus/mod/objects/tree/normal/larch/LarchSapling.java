...
public class LarchSapling extends BlockBush implements IGrowable, IMetaName, IHasModel
{	
    ...
    public LarchSapling(String name) 
    {
	...
	public void registerModels() 
	{
		...
		{
			Main.proxy.registerVariantRenderer(Item.getItemFromBlock(this), i, "larch_sapling" + "_" + TreeEnumHandler.EnumType.values()[i].getName(), "inventory");
		}
	}
