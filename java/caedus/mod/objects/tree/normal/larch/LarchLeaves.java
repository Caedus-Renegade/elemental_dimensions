package caedus.mod.objects.tree.normal.larch;
...
public class LarchLeaves extends BlockLeaves implements IMetaName, IHasModel
{
	...
	public LarchLeaves(String name) 
	{
...
//	{
//		return Item.getItemFromBlock(BlockInit.larch_sapling);
//	}
	...
	public void registerModels() 
	{
		...
		{
			Main.proxy.registerVariantRenderer(Item.getItemFromBlock(this), i, "larch_leaves" +"_" + TreeEnumHandler.EnumType.values()[i].getName(), "inventory");
		}
	}
}