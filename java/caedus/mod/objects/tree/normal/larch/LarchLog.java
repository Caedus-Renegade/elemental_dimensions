...
public class LarchLog extends BlockLog implements IMetaName, IHasModel
{
	...
	public void registerModels() 
	{
		...
		{
			Main.proxy.registerVariantRenderer(Item.getItemFromBlock(this), i, "larch_log_" + TreeEnumHandler.EnumType.values()[i].getName(), "inventory");
		}
	}	
}