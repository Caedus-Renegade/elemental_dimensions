...
public class AshSapling extends BlockBush implements IGrowable, IMetaName, IHasModel
{	
	...
	{
		return this.getDefaultState().withProperty(VARIANT, AshTreeEnumHandler.EnumType.byMetadata(meta & 1)).withProperty(STAGE, Integer.valueOf((meta & 8) >> 3));
	}
	...
	public void registerModels() 
	{
		...
		{
			Main.proxy.registerVariantRenderer(Item.getItemFromBlock(this), i, "ash_sapling" + "_" + AshTreeEnumHandler.EnumType.values()[i].getName(), "inventory");
		}
	}
	...
	public void generateTree(World world, Random rand, BlockPos pos, IBlockState state)
	{
		...
		switch((AshTreeEnumHandler.EnumType)state.getValue(VARIANT))
		{
		case ASH:
			gen = new AshTree();
			break;
