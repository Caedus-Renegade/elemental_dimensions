...
public class CragcliffLarchLog extends BlockLog implements IMetaName, IHasModel
{
	...
	public CragcliffLarchLog(String name) 
	{
	...
	public void registerModels() 
	{
		...
		{
			Main.proxy.registerVariantRenderer(Item.getItemFromBlock(this), i, "cragcliff_larch_log_" + TreeEnumHandler.EnumType.values()[i].getName(), "inventory");
		}
	}	
}