...
public class CragcliffLarchLeaves extends BlockLeaves implements IMetaName, IHasModel
{
	...
	public CragcliffLarchLeaves(String name) 
	{
...
//	{
//		return Item.getItemFromBlock(BlockInit.cragcliff_larch_sapling);
//	}
	...
	public void registerModels() 
	{
		...
		{
			Main.proxy.registerVariantRenderer(Item.getItemFromBlock(this), i, "cragcliff_larch_leaves" +"_" + TreeEnumHandler.EnumType.values()[i].getName(), "inventory");
		}
	}
}