...
public class RuemusTeakSapling extends BlockBush implements IGrowable, IMetaName, IHasModel
{	
    ...
    public RuemusTeakSapling(String name) 
    {
	...
	public void registerModels() 
	{
		...
		{
			Main.proxy.registerVariantRenderer(Item.getItemFromBlock(this), i, "ruemus_teak_sapling" + "_" + TreeEnumHandler.EnumType.values()[i].getName(), "inventory");
		}
	}
	...
	public void generateTree(World world, Random rand, BlockPos pos, IBlockState state)
	{
		...
		{
		case BASE:
			gen = new RuemusTeakTree(false, false);
			break;
		}
	...
	{
		return state.getBlock() == Blocks.GRASS || state.getBlock() == Blocks.DIRT || state.getBlock() == Blocks.FARMLAND || state.getBlock() == BlockInit.hydrostone;
	}
