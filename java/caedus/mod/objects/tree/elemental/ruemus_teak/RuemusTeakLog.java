...
public class RuemusTeakLog extends BlockLog implements IMetaName, IHasModel
{
	...
	public RuemusTeakLog(String name) 
	{
	...
	public void registerModels() 
	{
		...
		{
			Main.proxy.registerVariantRenderer(Item.getItemFromBlock(this), i, "ruemus_teak_log_" + TreeEnumHandler.EnumType.values()[i].getName(), "inventory");
		}
	}	
}