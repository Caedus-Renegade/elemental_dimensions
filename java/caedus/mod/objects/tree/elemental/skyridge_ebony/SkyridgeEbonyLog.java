...
public class SkyridgeEbonyLog extends BlockLog implements IMetaName, IHasModel
{
	...
	public SkyridgeEbonyLog(String name) 
	{
	...
	public void registerModels() 
	{
		...
		{
			Main.proxy.registerVariantRenderer(Item.getItemFromBlock(this), i, "skyridge_ebony_log_" + TreeEnumHandler.EnumType.values()[i].getName(), "inventory");
		}
	}	
}