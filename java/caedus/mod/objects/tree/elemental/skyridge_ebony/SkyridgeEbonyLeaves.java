...
public class SkyridgeEbonyLeaves extends BlockLeaves implements IMetaName, IHasModel
{
	...
	public SkyridgeEbonyLeaves(String name) 
	{
...
//	{
//		return Item.getItemFromBlock(BlockInit.skyridge_ebony_sapling);
//	}
	...
	public void registerModels() 
	{
		...
		{
			Main.proxy.registerVariantRenderer(Item.getItemFromBlock(this), i, "skyridge_ebony_leaves" +"_" + TreeEnumHandler.EnumType.values()[i].getName(), "inventory");
		}
	}
}