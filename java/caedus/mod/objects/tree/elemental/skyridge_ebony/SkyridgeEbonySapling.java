package caedus.mod.objects.tree.elemental.skyridge_ebony;
...
public class SkyridgeEbonySapling extends BlockBush implements IGrowable, IMetaName, IHasModel
{	
    ...
    public SkyridgeEbonySapling(String name) 
    {
	...
	public void registerModels() 
	{
		...
		{
			Main.proxy.registerVariantRenderer(Item.getItemFromBlock(this), i, "skyridge_ebony_sapling" + "_" + TreeEnumHandler.EnumType.values()[i].getName(), "inventory");
		}
	}
	...
	public void generateTree(World world, Random rand, BlockPos pos, IBlockState state)
	{
		...
		{
		case BASE:
			gen = new SkyridgeEbonyTree(false, false);
			break;
		}
	...
	{
		return state.getBlock() == Blocks.GRASS || state.getBlock() == Blocks.DIRT || state.getBlock() == Blocks.FARMLAND || state.getBlock() == BlockInit.zephyrstone;
	}
