...
public class PureCragniteOre extends Block implements IHasModel, IMetaName
{
	...
	public PureCragniteOre(String name)
	{
		super(Material.ROCK);
    ...
    {
        return ItemInit.pure_cragnite_shard;
    }
	...
	public void registerModels() 
	{
		...
		{
			Main.proxy.registerVariantRenderer(Item.getItemFromBlock(this), i, "pure_cragnite_ore_" + CragniteOreEnumHandler.EnumType.values()[i].getName(), "inventory");
		}
	}
}