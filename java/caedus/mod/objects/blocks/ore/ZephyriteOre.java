...
public class ZephyriteOre extends Block implements IHasModel, IMetaName
{
	...
	public ZephyriteOre(String name)
	{
		super(Material.ROCK);
    ...
    {
        return ItemInit.zephyrite_shard;
    }
	...
	public void registerModels() 
	{
		...
		{
			Main.proxy.registerVariantRenderer(Item.getItemFromBlock(this), i, "zephyrite_ore_" + ZephyriteOreEnumHandler.EnumType.values()[i].getName(), "inventory");
		}
	}
}