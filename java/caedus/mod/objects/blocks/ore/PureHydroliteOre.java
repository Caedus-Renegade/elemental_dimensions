...
public class PureHydroliteOre extends Block implements IHasModel, IMetaName
{
	...
	public PureHydroliteOre(String name)
	{
		super(Material.ROCK);
    ...
    {
        return ItemInit.pure_hydrolite_shard;
    }
	...
	public void registerModels() 
	{
		...
		{
			Main.proxy.registerVariantRenderer(Item.getItemFromBlock(this), i, "pure_hydrolite_ore_" + HydroliteOreEnumHandler.EnumType.values()[i].getName(), "inventory");
		}
	}
}