...
public class TileEntityCarbonSteelFurnace extends TileEntity implements IInventory, ITickable {
	...
	{
		return this.hasCustomName() ? this.customName : "container.carbon_steel_furnace";
	}
	...
	public void update()
	{
		...
		if(!this.world.isRemote)
		{
			...
			{
				flag1 = true;
				CarbonSteelFurnace.setState(this.isBurning(), this.world, this.pos);
			}
		} if(flag1)
			this.markDirty();
	}
	...
	private boolean canSmelt()
	{
		...
		{
			ItemStack result = CarbonSteelFurnaceRecipes.getInstance().getCarbonSteelFurnaceResult((ItemStack)this.inventory.get(0));
	...
	public void smeltItem()
	{
		if(this.canSmelt())
		{
			...
			ItemStack result = CarbonSteelFurnaceRecipes.getInstance().getCarbonSteelFurnaceResult(input1);
			ItemStack output = (ItemStack)this.inventory.get(2);
	...
	{
		return "ed:carbon_steel_furnace";
	}
