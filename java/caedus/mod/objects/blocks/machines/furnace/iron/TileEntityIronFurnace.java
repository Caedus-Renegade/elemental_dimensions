...
public class TileEntityIronFurnace extends TileEntity implements IInventory, ITickable {
	...
	{
		return this.hasCustomName() ? this.customName : "container.iron_furnace";
	}
	...
	private boolean canSmelt()
	{
		...
		{
			ItemStack result = IronFurnaceRecipes.getInstance().getIronFurnaceResult((ItemStack)this.inventory.get(0));
	...
	public void smeltItem()
	{
		if(this.canSmelt())
		{
			...
			ItemStack result = IronFurnaceRecipes.getInstance().getIronFurnaceResult(input1);
			ItemStack output = (ItemStack)this.inventory.get(2);
