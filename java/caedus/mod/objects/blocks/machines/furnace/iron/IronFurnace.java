...
public class IronFurnace extends BlockBase implements ITileEntityProvider 
{
	...
	{
		return Item.getItemFromBlock(BlockInit.iron_furnace);
	}
	...
	public static void setState(boolean active, World worldIn, BlockPos pos)
	{
		...
		if(active) worldIn.setBlockState(pos, BlockInit.iron_furnace.getDefaultState().withProperty(FACING, state.getValue(FACING)).withProperty(BURNING,  true), 3);
		else worldIn.setBlockState(pos, BlockInit.iron_furnace.getDefaultState().withProperty(FACING, state.getValue(FACING)).withProperty(BURNING, false), 3);
