...
public class SteelFurnaceGui extends GuiContainer {
	
	private static final ResourceLocation TEXTURES = new ResourceLocation(Reference.MODID + ":textures/gui/steel_furnace.png");
	private final InventoryPlayer player;
	private final TileEntitySteelFurnace tileentity;
	
	public SteelFurnaceGui(InventoryPlayer player, TileEntitySteelFurnace tileentity)
	{
