...
public class TileEntitySteelFurnace extends TileEntity implements IInventory, ITickable {
	...
	private boolean canSmelt()
	{
		...
		{
			ItemStack result = SteelFurnaceRecipes.getInstance().getSteelFurnaceResult((ItemStack)this.inventory.get(0));
	...
	public void smeltItem()
	{
		if(this.canSmelt())
		{
			...
			ItemStack result = SteelFurnaceRecipes.getInstance().getSteelFurnaceResult(input1);
			ItemStack output = (ItemStack)this.inventory.get(2);
