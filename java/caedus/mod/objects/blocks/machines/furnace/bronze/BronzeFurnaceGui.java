...
public class BronzeFurnaceGui extends GuiContainer {
	...
	public BronzeFurnaceGui(InventoryPlayer player, TileEntityBronzeFurnace tileentity)
	{
		super(new ContainerBronzeFurnace(player, tileentity));
		this.player = player;
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
	{
		...
		if (TileEntityBronzeFurnace.isBurning(tileentity))
		{
