...
public class TileEntityBronzeFurnace extends TileEntity implements IInventory, ITickable {
	...
	public void update()
	{
		...
		if(!this.world.isRemote)
		{
			...
			{
				flag1 = true;
				BronzeFurnace.setState(this.isBurning(), this.world, this.pos);
			}
		} if(flag1)
			this.markDirty();
	}
	...
	private boolean canSmelt()
	{
		...
		{
			ItemStack result = BronzeFurnaceRecipes.getInstance().getBronzeFurnaceResult((ItemStack)this.inventory.get(0));
	...
	public void smeltItem()
	{
		if(this.canSmelt())
		{
			...
			ItemStack result = BronzeFurnaceRecipes.getInstance().getBronzeFurnaceResult(input1);
			ItemStack output = (ItemStack)this.inventory.get(2);
