...
public class ContainerCopperFurnace extends Container {
	...
	public ContainerCopperFurnace(InventoryPlayer player, TileEntityCopperFurnace tileentity)
	{
        ...
        this.addSlotToContainer(new SlotCopperFurnaceFuelInput(tileentity, 1, 56, 53));
        this.addSlotToContainer(new SlotCopperFurnaceOutput(player.player, tileentity, 2, 116, 35));
	...
	public ItemStack transferStackInSlot(EntityPlayer playerIn, int index)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            {
                if (!CopperFurnaceRecipes.getInstance().getCopperFurnaceResult(itemstack1).isEmpty())
                {
