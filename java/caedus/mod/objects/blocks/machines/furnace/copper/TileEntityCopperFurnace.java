...
public class TileEntityCopperFurnace extends TileEntity implements IInventory, ITickable {
	...
	{
		return this.hasCustomName() ? this.customName : "container.copper_furnace";
	}
	...
	public void update()
	{
		...
		if(!this.world.isRemote)
		{
			...
			{
				flag1 = true;
				CopperFurnace.setState(this.isBurning(), this.world, this.pos);
			}
		} if(flag1)
			this.markDirty();
	}
	...
	private boolean canSmelt()
	{
		...
		{
			ItemStack result = CopperFurnaceRecipes.getInstance().getCopperFurnaceResult((ItemStack)this.inventory.get(0));
	...
	public void smeltItem()
	{
		if(this.canSmelt())
		{
			...
			ItemStack result = CopperFurnaceRecipes.getInstance().getCopperFurnaceResult(input1);
			ItemStack output = (ItemStack)this.inventory.get(2);
