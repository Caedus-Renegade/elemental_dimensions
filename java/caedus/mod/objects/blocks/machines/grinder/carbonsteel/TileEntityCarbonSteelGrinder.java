...
public class TileEntityCarbonSteelGrinder extends TileEntity implements IInventory, ITickable {
	...
	{
		return this.hasCustomName() ? this.customName : "container.carbon_steel_grinder";
	}
	...
	public void update()
	{
		...
		if(!this.world.isRemote)
		{
			...
			{
				flag1 = true;
				CarbonSteelGrinder.setState(this.isBurning(), this.world, this.pos);
			}
		} if(flag1)
			this.markDirty();
	}
	...
	private boolean canSmelt()
	{
		...
		{
			ItemStack result = CarbonSteelGrinderRecipes.getInstance().getCarbonSteelGrinderResult((ItemStack)this.inventory.get(0));
	...
	public void smeltItem()
	{
		if(this.canSmelt())
		{
			...
			ItemStack result = CarbonSteelGrinderRecipes.getInstance().getCarbonSteelGrinderResult(input1);
			ItemStack output = (ItemStack)this.inventory.get(2);
	...
	{
		return "ed:carbon_steel_grinder";
	}
