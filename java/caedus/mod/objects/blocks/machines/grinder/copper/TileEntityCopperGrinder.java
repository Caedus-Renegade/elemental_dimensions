...
public class TileEntityCopperGrinder extends TileEntity implements IInventory, ITickable {
	...
	{
		return this.hasCustomName() ? this.customName : "container.copper_grinder";
	}
	...
	public void update()
	{
		...
		if(!this.world.isRemote)
		{
			...
			{
				flag1 = true;
				CopperGrinder.setState(this.isBurning(), this.world, this.pos);
			}
		} if(flag1)
			this.markDirty();
	}
	...
	private boolean canSmelt()
	{
		...
		else
		{
			...
			ItemStack result = CopperGrinderRecipes.getInstance().getCopperGrinderResult((ItemStack)this.inventory.get(0));
...
//				return res <= getInventoryStackLimit() && res <= output.getMaxStackSize();
	...
	public void smeltItem()
	{
		if(this.canSmelt())
		{
			...
			ItemStack result = CopperGrinderRecipes.getInstance().getCopperGrinderResult(input1);
			ItemStack output = (ItemStack)this.inventory.get(2);
