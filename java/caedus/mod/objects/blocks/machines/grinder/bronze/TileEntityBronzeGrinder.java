...
public class TileEntityBronzeGrinder extends TileEntity implements IInventory, ITickable {
	...
	{
		return this.hasCustomName() ? this.customName : "container.bronze_grinder";
	}
	...
	public void update()
	{
		...
		if(!this.world.isRemote)
		{
			...
			{
				flag1 = true;
				BronzeGrinder.setState(this.isBurning(), this.world, this.pos);
			}
		} if(flag1)
			this.markDirty();
	}
	...
	private boolean canSmelt()
	{
		...
		else
		{
			...
			ItemStack result = BronzeGrinderRecipes.getInstance().getBronzeGrinderResult((ItemStack)this.inventory.get(0));
...
//				return res <= getInventoryStackLimit() && res <= output.getMaxStackSize();
	...
	public void smeltItem()
	{
		if(this.canSmelt())
		{
			...
			ItemStack result = BronzeGrinderRecipes.getInstance().getBronzeGrinderResult(input1);
			ItemStack output = (ItemStack)this.inventory.get(2);
