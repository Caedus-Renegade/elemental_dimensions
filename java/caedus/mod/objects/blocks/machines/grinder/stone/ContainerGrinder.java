...
public class ContainerGrinder extends Container {
	...
	public ContainerGrinder(InventoryPlayer player, TileEntityGrinder tileentity)
	{
        ...
        this.addSlotToContainer(new SlotGrinderFuelInput(tileentity, 1, 56, 53));
        this.addSlotToContainer(new SlotGrinderOutput(player.player, tileentity, 2, 116, 35));
	...
	public ItemStack transferStackInSlot(EntityPlayer playerIn, int index)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            else if (index != 1 && index != 0)
            {
                ...
                if (!GrinderRecipes.getInstance().getGrinderResult(itemstack1).isEmpty())
                {
