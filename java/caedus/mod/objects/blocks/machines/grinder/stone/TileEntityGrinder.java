...
public class TileEntityGrinder extends TileEntity implements IInventory, ITickable {
	...
	private boolean canSmelt()
	{
		...
		else
		{
			...
			ItemStack result = GrinderRecipes.getInstance().getGrinderResult((ItemStack)this.inventory.get(0));
...
//				return res <= getInventoryStackLimit() && res <= output.getMaxStackSize();
	...
	public void smeltItem()
	{
		if(this.canSmelt())
		{
			...
			ItemStack result = GrinderRecipes.getInstance().getGrinderResult(input1);
			ItemStack output = (ItemStack)this.inventory.get(2);
