...
public class Grinder extends BlockBase implements ITileEntityProvider 
{
	...
	{
		return Item.getItemFromBlock(BlockInit.grinder);
	}
	...
	public static void setState(boolean active, World worldIn, BlockPos pos)
	{
		...
		if(active) worldIn.setBlockState(pos, BlockInit.grinder.getDefaultState().withProperty(FACING, state.getValue(FACING)).withProperty(BURNING,  true), 3);
		else worldIn.setBlockState(pos, BlockInit.grinder.getDefaultState().withProperty(FACING, state.getValue(FACING)).withProperty(BURNING, false), 3);
