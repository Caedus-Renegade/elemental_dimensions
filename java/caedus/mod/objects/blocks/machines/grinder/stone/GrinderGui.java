...
public class GrinderGui extends GuiContainer {
	...
	private static final ResourceLocation TEXTURES = new ResourceLocation(Reference.MODID + ":textures/gui/grinder.png");
	private final InventoryPlayer player;
	private final TileEntityGrinder tileentity;
	
	public GrinderGui(InventoryPlayer player, TileEntityGrinder tileentity)
	{
