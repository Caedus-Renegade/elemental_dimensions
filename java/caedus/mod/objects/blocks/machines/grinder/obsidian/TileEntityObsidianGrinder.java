...
public class TileEntityObsidianGrinder extends TileEntity implements IInventory, ITickable {
	...
	{
		return this.hasCustomName() ? this.customName : "container.obsidian_grinder";
	}
	...
	public void update()
	{
		...
		if(!this.world.isRemote)
		{
			...
			{
				flag1 = true;
				ObsidianGrinder.setState(this.isBurning(), this.world, this.pos);
			}
		} if(flag1)
			this.markDirty();
	}
	...
	private boolean canSmelt()
	{
		...
		{
			ItemStack result = ObsidianGrinderRecipes.getInstance().getObsidianGrinderResult((ItemStack)this.inventory.get(0));
	...
	public void smeltItem()
	{
		if(this.canSmelt())
		{
			...
			ItemStack result = ObsidianGrinderRecipes.getInstance().getObsidianGrinderResult(input1);
			ItemStack output = (ItemStack)this.inventory.get(2);
