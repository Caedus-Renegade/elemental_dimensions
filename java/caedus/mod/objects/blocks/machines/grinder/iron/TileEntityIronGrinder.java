...
public class TileEntityIronGrinder extends TileEntity implements IInventory, ITickable {
	...
	{
		return this.hasCustomName() ? this.customName : "container.iron_grinder";
	}
	...
	public void update()
	{
		...
		if(!this.world.isRemote)
		{
			...
			{
				flag1 = true;
				IronGrinder.setState(this.isBurning(), this.world, this.pos);
			}
		} if(flag1)
			this.markDirty();
	}
	...
	private boolean canSmelt()
	{
		...
		{
			ItemStack result = IronGrinderRecipes.getInstance().getIronGrinderResult((ItemStack)this.inventory.get(0));
	...
	public void smeltItem()
	{
		if(this.canSmelt())
		{
			...
			ItemStack result = IronGrinderRecipes.getInstance().getIronGrinderResult(input1);
			ItemStack output = (ItemStack)this.inventory.get(2);
