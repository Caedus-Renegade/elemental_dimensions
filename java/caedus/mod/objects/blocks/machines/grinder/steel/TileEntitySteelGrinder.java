...
public class TileEntitySteelGrinder extends TileEntity implements IInventory, ITickable {
	...
	{
		return this.hasCustomName() ? this.customName : "container.steel_grinder";
	}
	...
	public void update()
	{
		...
		if(!this.world.isRemote)
		{
			...
			{
				flag1 = true;
				SteelGrinder.setState(this.isBurning(), this.world, this.pos);
			}
		} if(flag1)
			this.markDirty();
	}
	...
	private boolean canSmelt()
	{
		...
		{
			ItemStack result = SteelGrinderRecipes.getInstance().getSteelGrinderResult((ItemStack)this.inventory.get(0));
	...
	public void smeltItem()
	{
		if(this.canSmelt())
		{
			...
			ItemStack result = SteelGrinderRecipes.getInstance().getSteelGrinderResult(input1);
			ItemStack output = (ItemStack)this.inventory.get(2);
