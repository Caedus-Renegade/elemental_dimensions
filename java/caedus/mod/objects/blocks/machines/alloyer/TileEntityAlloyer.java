...
public class TileEntityAlloyer extends TileEntity implements IInventory, ITickable
{
	...
	public void update() 
	{
		...
		if(!this.world.isRemote) 
		{
			...
			{
				flag1 = true;
				Alloyer.setState(this.isBurning(), this.world, this.pos);
			}
		} 
	...
	private boolean canSmelt() 
	{
		...
		{
			ItemStack result = AlloyerRecipes.getInstance().getAlloyerResult((ItemStack)this.inventory.get(0), (ItemStack)this.inventory.get(1));	
	...
	public void smeltItem() 
	{
		if(this.canSmelt()) 
		{
			...
			ItemStack result = AlloyerRecipes.getInstance().getAlloyerResult(input1, input2);
			ItemStack output = (ItemStack)this.inventory.get(3);
